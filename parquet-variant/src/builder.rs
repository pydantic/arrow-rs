...
/// );
///
/// let Variant::Object(obj2) = variant_list.get(1).unwrap() else {
///     panic!("unexpected variant type");
/// };
///
/// assert_eq!(
...
mod tests {
    ...
    fn test_nested_list() {
        ...
        let Variant::List(outer_list) = Variant::try_new(&metadata, &value).unwrap() else {
            panic!()
        };

        assert_eq!(outer_list.len(), 1);

        let Variant::List(inner_list) = outer_list.get(0).unwrap() else {
            panic!()
        };
    ...
    fn test_super_nested_list() {
        ...
        */
        ...
        let Variant::List(list1) = Variant::try_new(&metadata, &value).unwrap() else {
            panic!("expected");
        };

        assert_eq!(list1.len(), 1);

        let Variant::List(list2) = list1.get(0).unwrap() else {
            panic!("");
        };

        assert_eq!(list2.len(), 1);

        let Variant::List(list3) = list2.get(0).unwrap() else {
            panic!("");
        };

        assert_eq!(list3.len(), 1);
        let Variant::List(list4) = list3.get(0).unwrap() else {
            panic!("");
        };

        assert_eq!(list4.len(), 1);
        let Variant::List(list5) = list4.get(0).unwrap() else {
            panic!("");
        };
    ...
    fn test_object_list() {
        ...
        let Variant::Object(obj1) = list.get(0).unwrap() else {
            panic!()
        };
        ...
        let Variant::Object(obj2) = list.get(1).unwrap() else {
            panic!()
        };
    ...
    fn test_hetergenous_list() {
        ...
        */
        ...
        let Variant::Object(obj1) = list.get(1).unwrap() else {
            panic!()
        };
        ...
        let Variant::Object(obj2) = list.get(3).unwrap() else {
            panic!()
        };
