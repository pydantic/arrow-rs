...
impl Scan {
    ...
    fn builder(&self) -> ParquetPushDecoderBuilder {
        let mut builder = ParquetPushDecoderBuilder::new_with_metadata(self.metadata());
...
// ---------------------------------------------------------------------------
// Different page boundaries per column
// ---------------------------------------------------------------------------
...
/// Seeds of [`randomized_equivalence_heterogeneous_pages`], so that it runs
...
#[test]
fn batch_size_zero_without_rows() {
